...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(44, 200, 501, 16))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(7)
        font.setItalic(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "To cancel an order double click the cell with the order number."))
